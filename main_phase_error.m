...
ula1 = plotpattern(gc,tp,Wt_next1.');

ula2 = plotpattern(gc,tp,Wr_next2.');
...
ula3 = plotpattern(gc,tp,Wt_next2.');
ula4 = plotpattern(gc,tp,Wr_next1.');
figure;
subplot(221)
...
subplot(222)
    ...
    title('Dev2-rxomni');
subplot(224)
    plotResponse(ula3,gc.fc,gc.cLight,'RespCut','Az','Format','Polar','Unit','dbi','AzimuthAngles',union(-180:-90,90:180));
    title('Dev2-txomni');
subplot(223)
    plotResponse(ula4,gc.fc,gc.cLight,'RespCut','Az','Format','Polar','Unit','dbi','AzimuthAngles',-90:90);
    title('Dev1-rxomni');
...
ula1 = plotpattern(gc,tp,Wt_next3.');

ula2 = plotpattern(gc,tp,Wr_next4.');
%tx_Dev2 and rx_Dev1
...
ula3 = plotpattern(gc,tp,Wt_next4.');
ula4 = plotpattern(gc,tp,Wr_next3.');
figure;
subplot(221)
    plotResponse(ula1,gc.fc,gc.cLight,'RespCut','Az','Format','Polar','Unit','dbi','AzimuthAngles',-90:90);
    title('Dev1-txsec');
...
ula1 = plotpattern(gc,tp,Wt_next5.');
ula2 = plotpattern(gc,tp,Wr_next6.');
%tx_Dev2 and rx_Dev1
...
ula3 = plotpattern(gc,tp,Wt_next6.');
ula4 = plotpattern(gc,tp,Wr_next5.');
figure;
subplot(221)
    plotResponse(ula1,gc.fc,gc.cLight,'RespCut','Az','Format','Polar','Unit','dbi','AzimuthAngles',-90:90);
    title('Dev1-txbeam');
